            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <div style="float: left; padding-right: 200px; text-align: center; font-size: 50px"><a href="ViewAllRepairList?Status=tech"><img src="img/tech.png" height= 350px width=350px"></a><br>Repair Request List</div>
                    <!-- /.col-lg-12 -->
                </div>
